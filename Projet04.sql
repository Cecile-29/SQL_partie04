...
--- Exercice 02 Dans la table frameworks insérez les données suivantes :
    -- REACT version 16.1
    -- REACT version 16.3
    -- REACT version 16.4
    -- REACT version 16.5
...
--- Exercice 03 Dans la table languages, afficher toutes les données de la table.
    SELECT * FROM `languages`;

--- Exercice 04 Dans la table languages, afficher toutes les versions de PHP.
    SELECT version FROM languages WHERE language='PHP';

--- Exercice 05 Dans la table languages, afficher les lignes ayant pour id 1,3,4.
